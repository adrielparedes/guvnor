...
public class CommentsPresenterTest {
    ...
    public void setUp() {
        ...
        when( user.getIdentifier() ).thenReturn( "kie" );
        ...
        presenter = new CommentsPresenter( view, caller, translationService, commentPresenters, notificationManager, mergeEvent, placeManager, sessionInfo );
    ...
    public void testAddSeveralContents() throws Exception {
        presenter.comment( "content1" );
        presenter.comment( "content2" );
        presenter.comment( "content3" );
        presenter.comment( "content4" );
        presenter.comment( "content5" );
        final List<Comment> response = service.getCommentsByPullRequetsId( pullRequest.getTargetRepository(), pullRequest.getId() );
